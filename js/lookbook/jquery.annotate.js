(function($) {
    ...
    **/
    ...
    $.fn.annotateEdit = function(image, note) {
		...
		var formHtml = '<div id="image-annotate-edit-form"><form id="annotate-edit-form"><table class="form-list" cellspacing="0"><tbody><tr><td class="label"><label for="image-annotate-text">Product Sku: </label></td><td class="value"><input id="image-annotate-text" value="'+this.note.text+'" name="text" type="text" class=" input-text"/><div id="sku_loader" style="display:none"></div><div id="sku_autocomplete_choices" class="sku-autocomplete" style="display: none;"></div></td></tr><tr><td class="label"><label for="image-annotate-label">Pin Label: </label></td><td class="value"><input id="image-annotate-label" value="'+this.note.label+'" name="label" type="text" class=" input-text"/></td></tr><tr><td class="label"><label for="image-annotate-position">Popup Position: </label></td><td class="value">';
