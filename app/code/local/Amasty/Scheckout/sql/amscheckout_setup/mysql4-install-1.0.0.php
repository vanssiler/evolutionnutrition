...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/config')}` (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/area')}` (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/area_store')}` (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/field')}` (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/field_store')}` (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/country')}` (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/block')}` (
...
CREATE TABLE IF NOT EXISTS `{$this->getTable('amscheckout/location')}` (
...
('billing:vat_id', 'VAT Number', @billingAreaId, 800, FALSE, 50, FALSE),
('billing:street1', 'Address', @billingAreaId, 850, TRUE, 100, FALSE),
('billing:country_id', 'Country', @billingAreaId, 900, TRUE, 50, FALSE),
('billing:region_id', 'State/Province', @billingAreaId, 1000, TRUE, 50, FALSE),
('billing:city', 'City', @billingAreaId, 1100, TRUE, 50, FALSE),
('billing:postcode', 'Zip/Postal Code', @billingAreaId, 1200, TRUE, 50, FALSE),
('billing:company', 'Company', @billingAreaId, 1350, FALSE, 50, FALSE),
...
('shipping:vat_id', 'VAT Number', @shippingAreaId, 700, FALSE, 50, FALSE),
('shipping:street1', 'Address', @shippingAreaId, 750, TRUE, 100, FALSE),
('shipping:country_id', 'Country', @shippingAreaId, 800, TRUE, 50, FALSE),
('shipping:region_id', 'State/Province', @shippingAreaId, 900, TRUE, 50, FALSE),
('shipping:city', 'City', @shippingAreaId, 1000, TRUE, 50, FALSE),
('shipping:postcode', 'Zip/Postal Code', @shippingAreaId, 1100, TRUE, 50, FALSE),
('shipping:company', 'Company', @shippingAreaId, 1250, FALSE, 50, FALSE),
...
UPDATE `{$this->getTable('amscheckout/field')}` set
`field_disabled` = TRUE
WHERE field_key IN ('billing:middlename', 'billing:fax', 'shipping:middlename', 'shipping:fax');
