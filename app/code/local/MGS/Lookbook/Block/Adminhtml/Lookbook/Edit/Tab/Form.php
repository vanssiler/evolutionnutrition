 ...
 */
class MGS_Lookbook_Block_Adminhtml_Lookbook_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset = $form->addFieldset('lookbook_form', array('legend'=>Mage::helper('lookbook')->__('Lookbook Information')));
     
      $fieldset->addField('name', 'text', array(
          'label'     => Mage::helper('lookbook')->__('Lookbook Name'),
          'required'  => true,
          'name'      => 'name',
      ));
      ...
      $fieldset->addType('lookbookimage','MGS_Lookbook_Block_Adminhtml_Lookbook_Edit_Form_Lookbookimage');
      ...
      $fieldset->addField('pins', 'hidden', array(
          'name'      => 'pins',
      ));
