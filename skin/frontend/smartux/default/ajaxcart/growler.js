...
Growler = (function(){
	...
	return Class.create({
		...
		,warn: function(msg, options){
			return specialNotice(this.growler, msg, options, "Por favor aguarde!", "#F6BD6F", "#000");
		}
		,error: function(msg, options){
			return specialNotice(this.growler, msg, options, "Erro!", "#F66F82", "#000");
		}
		,info: function(msg, options){
			return specialNotice(this.growler, msg, options, "Sucesso!", "#BBF66F", "#000");
		}
